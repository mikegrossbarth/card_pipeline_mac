...
class CardPipelineApp(tk.Tk):
    ...
    def open_trade_portal_popup(self) -> None:
        ...
        ttk.Label(header, text="Same trade engine as mobile", style="Muted.TLabel").grid(row=0, column=1, sticky="w", padx=(12, 0))
        ...
        outgoing_actions = ttk.Frame(outgoing_panel, style="Panel.TFrame")
        outgoing_actions.grid(row=0, column=1, sticky="e")
        ttk.Button(outgoing_actions, text="Remove Selected", command=lambda: remove_selected_outgoing(), style="Soft.TButton").pack(side=tk.LEFT)
